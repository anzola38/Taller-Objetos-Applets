...
import Busqueda.BubbleSort;
import Busqueda.InterpolationSearch;
...
public class Applet extends JApplet {
	...
	public void busqueda(int index, int dato, int[] numeros) {
		...
		if (index == 0) {
			...
			panelprincipal.imprimir(binarysearch.binarysearch(bubblesort.burbuja(numeros), dato));
			...
			if (index == 1) {
				...
				panelprincipal.imprimir(interpolationsearch.interpolationSearch(bubblesort.burbuja(numeros), dato));
				...
				if (index == 2) {
					...
					panelprincipal.imprimir(linearsearch.linearsearch(bubblesort.burbuja(numeros), dato));
